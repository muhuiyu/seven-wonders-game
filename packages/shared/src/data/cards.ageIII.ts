...
export const AGE_III_CARDS: Card[] = [
  // --- Blue: civilian ---
  { id: "pantheon", name: "Pantheon", age: 3, color: "blue", cost: [{ resources: { clay: 2, ore: 1, glass: 1, loom: 1, papyrus: 1 } }], chainFrom: ["temple"], effects: [{ kind: "vp", amount: 7 }] },
  { id: "gardens", name: "Gardens", age: 3, color: "blue", cost: [{ resources: { clay: 2, wood: 1 } }], chainFrom: ["statue"], effects: [{ kind: "vp", amount: 5 }] },
  { id: "town-hall", name: "Town Hall", age: 3, color: "blue", cost: [{ resources: { stone: 2, ore: 1, glass: 1 } }], effects: [{ kind: "vp", amount: 6 }] },
  ...
  { id: "senate", name: "Senate", age: 3, color: "blue", cost: [{ resources: { wood: 2, stone: 1, papyrus: 1 } }], effects: [{ kind: "vp", amount: 6 }] },
  { id: "obelisk", name: "Obelisk", age: 3, color: "blue", cost: [{ resources: { wood: 2, stone: 2 } }], effects: [{ kind: "vp", amount: 5 }] },

  // --- Red: military ---
  { id: "fortifications", name: "Fortifications", age: 3, color: "red", cost: [{ resources: { ore: 3, stone: 1 } }], effects: [{ kind: "shields", count: 2 }] },
  { id: "circus", name: "Circus", age: 3, color: "red", cost: [{ resources: { stone: 3, ore: 1 } }], effects: [{ kind: "shields", count: 2 }] },
  { id: "arsenal", name: "Arsenal", age: 3, color: "red", cost: [{ resources: { ore: 2, wood: 2, loom: 1 } }], effects: [{ kind: "shields", count: 3 }] },
  { id: "siege-workshop", name: "Siege Workshop", age: 3, color: "red", cost: [{ resources: { wood: 3, clay: 1 } }], effects: [{ kind: "shields", count: 2 }] },
  ...
  { id: "university", name: "University", age: 3, color: "green", cost: [{ resources: { wood: 2, papyrus: 1, loom: 1 } }], chainFrom: ["library"], effects: [{ kind: "science", symbol: "tablet" }] },
  ...
  { id: "arena", name: "Arena", age: 3, color: "yellow", cost: [{ resources: { stone: 2, ore: 1 } }], effects: [{ kind: "vpPerWonderStage", scope: "self", perStage: 1 }, { kind: "coins", amount: 3 }] },
