...
export const LEADER_CARDS: LeaderCard[] = [
  { id: "alexander", name: "Alexander", coinCost: 3, effects: [{ kind: "vpPerMilitaryToken", result: "win", scope: "self", perToken: 1 }] },
  { id: "amytis", name: "Amytis", coinCost: 4, effects: [{ kind: "vpPerWonderStage", scope: "self", perStage: 2 }] },
  { id: "archimedes", name: "Archimedes", coinCost: 4, effects: [{ kind: "buildDiscount", appliesTo: "green", units: 1 }] },
  ...
  { id: "hammurabi", name: "Hammurabi", coinCost: 2, effects: [{ kind: "buildDiscount", appliesTo: "blue", units: 1 }] },
  ...
  { id: "hiram", name: "Hiram", coinCost: 3, effects: [{ kind: "vpPerCard", color: "purple", scope: "self", perCard: 2 }] },
  { id: "hypatia", name: "Hypatia", coinCost: 4, effects: [{ kind: "vpPerCard", color: "green", scope: "self", perCard: 1 }] },
  { id: "imhotep", name: "Imhotep", coinCost: 3, effects: [{ kind: "buildDiscount", appliesTo: "wonderStage", units: 1 }] },
  { id: "justinian", name: "Justinian", coinCost: 3, effects: [{ kind: "vpPerColorSetBonus", colors: ["blue", "red", "green"], perSet: 3 }] },
  ...
  { id: "nebuchadnezzar", name: "Nebuchadnezzar", coinCost: 4, effects: [{ kind: "vpPerCard", color: "blue", scope: "self", perCard: 1 }] },
  ...
  { id: "pericles", name: "Pericles", coinCost: 6, effects: [{ kind: "vpPerCard", color: "red", scope: "self", perCard: 2 }] },
  { id: "phidias", name: "Phidias", coinCost: 3, effects: [{ kind: "vpPerCard", color: "brown", scope: "self", perCard: 1 }] },
  {
    id: "plato",
    name: "Plato",
    coinCost: 4,
    effects: [{ kind: "vpPerColorSetBonus", colors: ["brown", "grey", "blue", "yellow", "green", "red", "purple"], perSet: 7 }],
  },
  { id: "praxiteles", name: "Praxiteles", coinCost: 3, effects: [{ kind: "vpPerCard", color: "grey", scope: "self", perCard: 2 }] },
  ...
  { id: "varro", name: "Varro", coinCost: 3, effects: [{ kind: "vpPerCard", color: "yellow", scope: "self", perCard: 1 }] },
  { id: "vitruvius", name: "Vitruvius", coinCost: 1, effects: [{ kind: "coinsOnChainBuild", amount: 2 }] },
  { id: "xenophon", name: "Xenophon", coinCost: 2, effects: [{ kind: "coinsOnColorBuild", color: "yellow", amount: 2 }] },
